...
import { authSateController, changeRole, createUserController, forgotPassword, generateAccessToken, loginController, recoverPassword, resetPassword } from "./auth.controller";
